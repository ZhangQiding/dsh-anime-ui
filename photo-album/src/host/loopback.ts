/**
 * Loopback trust fence for the /api/photo-album/* routes: socket address, Host
 * header, and browser same-origin markers. A LAN-exposed deployment must not be
 * able to enumerate or read photo bytes, so every route checks this first.
 * @module dsh-photo-album/host/loopback
 */
